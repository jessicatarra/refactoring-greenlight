...
// InsertNewUser provides a mock function with given fields: user, hashedPassword
func (_m *UserRepository) InsertNewUser(user *domain.User, hashedPassword string) error {
	ret := _m.Called(user, hashedPassword)
